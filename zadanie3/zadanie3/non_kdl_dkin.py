...
class StatePublisher(Node):
    ...
    def __init__(self):
        ...
        self.joint_state = self.create_subscription(JointState, 'joint_states', self.listener_callback, qos_profile)
    ...
    def listener_callback(self, msg):
        ...
        print("uslyszalem :D :" + str(self.poz1))

        # self.odom_trans.header.stamp = now.to_msg()

        # send the joint state and transform
        # self.pose_pub.publish(self.joint_state)
